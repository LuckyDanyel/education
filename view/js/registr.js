...
/***/ "./blocks/forms/registr/registr.js":
/*!*****************************************!*\
  !*** ./blocks/forms/registr/registr.js ***!
  \*****************************************/
...
var getRegistrForm = document.querySelector('.registr-form');
...
/* harmony import */ var _registration_pug__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./registration.pug */ "./pages/registration/registration.pug");
/* harmony import */ var _registration_pug__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_registration_pug__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _blocks_forms_registr_registr_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../blocks/forms/registr/registr.js */ "./blocks/forms/registr/registr.js");
/* harmony import */ var _blocks_forms_registr_registr_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_blocks_forms_registr_registr_js__WEBPACK_IMPORTED_MODULE_5__);
...
/***/ "./pages/registration/registration.pug":
/*!*********************************************!*\
  !*** ./pages/registration/registration.pug ***!
  \*********************************************/
...
pug_mixins["header"]();
pug_indent.pop();
pug_html = pug_html + "\n    \u003Cmain class=\"main-registr\"\u003E\n      \u003Cdiv class=\"main-registr__inner\"\u003E\n        \u003Cdiv class=\"main-registr__image-block\"\u003E\u003Cimg" + (" class=\"main-registr__imgae\""+pug.attr("src", __webpack_require__(/*! ../bg.jpg */ "./pages/bg.jpg"), true, true)+" alt=\"backgroundimage\"") + "\u003E\u003C\u002Fdiv\u003E\n        \u003Cdiv class=\"main-registr__wrapper\"\u003E\n          \u003Cdiv class=\"registr\"\u003E\n            \u003Cform class=\"registr-form\" action=\"\"\u003E\n              \u003Cdiv class=\"registr__name\"\u003E";
...
pug_html = pug_html + "\n                    ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Ch1 class=\"text__heading-registr\"\u003EРегистрация аккаунта\u003C\u002Fh1\u003E";
}
else
if (condition == "enter") {
pug_html = pug_html + "\n                    ";
...
pug_indent.push("                ");
pug_mixins["TextUser"]("Имя", "Фамилия", "registr", "Name", "Second-name");
pug_indent.pop();
pug_html = pug_html + "\n              \u003C\u002Fdiv\u003E\n              \u003Cdiv class=\"registr__sex\"\u003E";
pug_mixins["RadioSex"] = pug_interp = function(GroupName){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\n                ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cdiv class=\"radio\"\u003E\n                  ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Ch3 class=\"radio__heading\"\u003E\u003C\u002Fh3\u003E\n                  ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cdiv class=\"radio__inner\"\u003E\n                    ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cdiv class=\"radio__block\"\u003E\n                      ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Clabel" + (" class=\"radio__label\""+pug.attr("for", "men-" + GroupName, true, true)) + "\u003E\n                        ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cinput" + (" class=\"radio__input\""+pug.attr("name", GroupName, true, true)+" type=\"radio\""+pug.attr("id", "men-" + GroupName, true, true)) + "\u003E\u003Cspan class=\"radio__fake\"\u003E\u003C\u002Fspan\u003E\n                        ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cp class=\"radio__text\"\u003EМужчина\u003C\u002Fp\u003E\n                      ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003C\u002Flabel\u003E\n                    ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003C\u002Fdiv\u003E\n                    ";
...
pug_html = pug_html + "\u003Cdiv class=\"radio__block\"\u003E\n                      ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Clabel" + (" class=\"radio__label\""+pug.attr("for", "mele-" + GroupName, true, true)) + "\u003E\n                        ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cinput" + (" class=\"radio__input\""+pug.attr("name", GroupName, true, true)+" type=\"radio\""+pug.attr("id", "mele-" + GroupName, true, true)) + "\u003E\u003Cspan class=\"radio__fake\"\u003E\u003C\u002Fspan\u003E\n                        ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cp class=\"radio__text\"\u003EЖенщина\u003C\u002Fp\u003E\n                      ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003C\u002Flabel\u003E\n                    ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003C\u002Fdiv\u003E\n                  ";
...
pug_indent.push("                ");
pug_mixins["RadioSex"]("SecondSex");
pug_indent.pop();
pug_html = pug_html + "\n              \u003C\u002Fdiv\u003E\n              \u003Cdiv class=\"registr__date\"\u003E";
pug_mixins["TextDate"] = pug_interp = function(nameDate){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\n                ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cdiv class=\"text\"\u003E\n                  ";
...
pug_html = pug_html + "\u003C\u002Flabel\u003E\n                  ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cinput" + (" class=\"text__date text__global text__global_hover-focus\""+" type=\"text\""+pug.attr("name", nameDate, true, true)+pug.attr("id", "text-date-" + nameDate, true, true)+" placeholder=\"ММ.ДД.ГГ\"") + "\u003E\n                ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
};
pug_indent.push("                ");
pug_mixins["TextDate"]("SecondDate");
pug_indent.pop();
...
pug_indent.push("                ");
pug_mixins["TextUser"]("Email", "Пароль", "registr-data", "RegistrEmail", "RegistrPassword");
pug_indent.pop();
pug_html = pug_html + "\n              \u003C\u002Fdiv\u003E\n              \u003Cdiv class=\"registr__toggle\"\u003E";
pug_mixins["Toggle"] = pug_interp = function(nameToggle){
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\n                ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cdiv class=\"toggle\"\u003E\n                  ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Clabel" + (" class=\"toggle__label\""+pug.attr("for", "invite-" + nameToggle, true, true)) + "\u003EПолучать спец предложения\n                    ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003Cinput" + (" class=\"toggle__input\""+" type=\"checkbox\""+pug.attr("id", "invite-" + nameToggle, true, true)+pug.attr("name", "invite-" + nameToggle, true, true)) + "\u003E\u003Cspan class=\"toggle__fake\"\u003E\u003C\u002Fspan\u003E\n                  ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003C\u002Flabel\u003E\n                ";
pug_html = pug_html + pug_indent.join("");
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
...
pug_indent.push("                ");
pug_mixins["Toggle"]("second");
pug_indent.pop();
pug_html = pug_html + "\n              \u003C\u002Fdiv\u003E\n              \u003Cdiv class=\"registr__pay\"\u003E";
...
pug_indent.push("                ");
pug_mixins["buttonBig"]("Зарегистрироваться");
pug_indent.pop();
pug_html = pug_html + "\n              \u003C\u002Fdiv\u003E\n              \u003Cdiv class=\"registr__footer\"\u003E\n                \u003Cp class=\"registr__text\"\u003EУже есть аккаунт на Toxin?\u003C\u002Fp\u003E\u003Ca href=\"login.html\"\u003E";
...
pug_indent.push("                  ");
pug_mixins["buttonWithBorder"]("Войти");
pug_indent.pop();
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_jquery_dist_jquery_js-node_modules_pug-runtime_index_js-node_modules_uti-f141bf","vendors-node_modules_jquery-validation_dist_jquery_validate_js"], () => (__webpack_require__("./pages/registration/registration.js")))
